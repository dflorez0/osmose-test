...
local et = osmose.Model 'OrganicRankineCycle'
...
et.inputs = {
    ...
    -- Condensor
    COND_TIN = {default=30, unit='°C'},
    COND_TOUT = {default=30, unit='°C'},
    -- Electricity output
    EMAX = {default=5000, unit='kW'},
    -- Efficiency
...
et:addUnit('ORC',{type='Utility', Fmin = 0, Fmax = 1, Cost1=0, Cost2='COST2', Cinv1=0, Cinv2=0, Power1=0, Power2=0, Impact1=0,Impact2=0})
et['ORC']:addStreams{
    -- Heat
